...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/INDOHACKER-XODE/Watermark-Bot)
...
#### The Hard Way 🤕
```sh
git clone https://github.com/INDOHACKER-XODE/Watermark-Bot
cd Watermark-Bot
